...
const skillsByRole = {
  frontend: [
    ...
    { name: "JavaScript (ES6+)", icon: FaJs, color: "rgb(65, 8, 7)" },
  ...
  fullstack: [
    ...
    { name: "JavaScript (ES6+)", icon: FaJs, color: "#ffd321" },
    { name: "TypeScript", icon: SiTypescript, color: "#3178C6" },
    { name: "Tailwind CSS", icon: SiTailwindcss, color: "#38BDF8" },
      ...
      <div className="mx-auto mt-1 mb-5 max-w-6xl lg:mt-1">
        ...
        <div className="grid grid-cols-2 mx-auto p-2 sm:grid-cols-3 md:grid-cols-4 lg:w-4xl lg:h-90 gap-8">
          {skills.map(({ name, icon: Icon, color }) => (
            ...
            >
              <Icon
                className="text-5xl mb-3 transition-transform group-hover:rotate-6"
                style={{ color }}
              />
              <span className="text-sm font-quicksand font-bold text-gray-800 dark:text-gray-200">
                {name}
              </span>
